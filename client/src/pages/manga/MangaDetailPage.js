...
const MangaDetailContent = () => {
  return (
    <div className="backdrop-blur-lg bg-white/[100%] mt-52">
      <div className="page-wrapper relative">
        <div className="absolute -top-52 flex gap-4">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="pt-10">
              <div className="flex h-14 gap-4 w-fit justify-between">
              ...
              <div className="mt-2 flex gap-1">
                ...
                <BasicTag className="bg-white" label={"Suggestive"}></BasicTag>
                <BasicTag className="bg-white" label={"Suggestive"}></BasicTag>
                <BasicTag className="bg-white" label={"Suggestive"}></BasicTag>
                {/* ))} */}
              </div>
