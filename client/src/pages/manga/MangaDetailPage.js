...
const MangaDetailPage = () => {
  ...
  return isLoading ? (
    <MangaDetailContentSkeleton></MangaDetailContentSkeleton>
  ) : (
    <div
      style={{
        // height: "100vh",
      ...
      <div className="backdrop-blur-lg h-full bg-black/20 pt-52">
        <div className="mt-20">
          <div className="relative backdrop-blur-lg h-full bg-white/[100%]">
            <MangaDetailContent manga={manga}></MangaDetailContent>
          </div>
        </div>
      </div>
    </div>
...
const MangaDetailContentSkeleton = ({ manga, ...props }) => {
  return (
...
const MangaDetailContent = ({ manga, ...props }) => {
